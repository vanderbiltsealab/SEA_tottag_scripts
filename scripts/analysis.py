...
with open(DATAFILE) as f:
    ...
    if tag.strip():  # strip will remove all leading and trailing whitespace such as '\n' or ' ' by default
        ...
        # .split() documenation: https://python-reference.readthedocs.io/en/latest/docs/str/split.html
        ...
        if line[0] != '#':
            ...
            if int(tokens[2]) != OUT_OF_RANGE_CODE :
                ...
                if int(tokens[2]) <= 915:
                    ...
                    distanceInCheckInRange = tokens[2] # assuming operations are matrix-wise, this should
                    # give us token totTagIDs exclusively inside 3ft
                    ...
                    # print('this is outCheckInRange', outCheckInRange) ## works as intended

                    #next step is to differentiate them by timeStamp since they are unique!
